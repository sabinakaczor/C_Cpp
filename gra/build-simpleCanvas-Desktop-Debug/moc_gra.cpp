...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Gra_t, stringdata) + ofs \
...
QT_MOC_LITERAL(7, 70, 1)
    },
    "Gra\0paintEvent\0\0QPaintEvent*\0event\0"
    "on_pushButton_clicked\0handleButton\0i\0"
};
...
const QMetaObject Gra::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Gra.data,
      qt_meta_data_Gra,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Gra.stringdata))
